                ...
                <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                        <div className="flex justify-center items-center w-[50px] h-[50px] rounded-full cursor-pointer hover:bg-[#4a82f6] transition-all duration-150 delay-100 mx-[6px]">
                            <img className="w-[46px] rounded-full cursor-pointer hover:brightness-75" alt="User" src={userPicUrl} />    
                        </div>
                        <div className="mr-[29px] text-[18px] cursor-pointer">{userName}</div>
                    </div>
                </div>
            </div>
        </div>
