...
function SideBar() {
    ...
    function handleOpen () {
        if (!isOpen) {
            return (
                <div className='btn-sideBar hover:bg-[#4A82F6]' onClick={() => setIsOpen(!isOpen)}>
                    <div className='icon-sideBar'><FiLogIn /></div> 
            ...
            return (
                <div className='btn-sideBar hover:bg-[#4A82F6]' onClick={() => setIsOpen(!isOpen)}>
                    <div className='icon-sideBar'><FiLogOut /></div> 
    ...
    return (
        <div className='w-[212px] bg-[white] flex flex-col justify-between rounded-l-[35px] border'>
            <div className='mt-[41px] ml-[37px] mb-[57px] text-[28px] '>LOGO</div>
